Page({
  data: {
    ...
    pageConfig: [
      //
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;以苏州传统第宅庭园布局和结构形式为基调，吸纳北方建筑风格，融合西洋建筑特征，多元文化碰撞，独树一帜。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;清秀柔和，隽秀挺拔，佛、儒文化碰撞的灿烂产物，吴越遗韵的典型代表。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;李鸿章：琼楼玉宇，曲栏洞房，真如神仙窟宅；花园三四所，戏台两三座，平生所未见之境也。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;苏东坡：尝言过姑苏不游虎丘，不谒闾丘，乃二欠事",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;苏州“双笔”，雕刻、建筑、艺术价值的集大成者，喧嚣中的一抹宁静。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中国第一所西制大学，绿荫红瓦相映，带你感受静谧校园中的多元欧式建筑之美。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掇山开池，建廊置亭，结构布局曲折多变，颇有小中见大之奇。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;释家记忆的典范，中国古代建筑中的“纪念碑性”，结构雄杰冠江南的大作。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;设学立庙，庙学合一，东南学宫之最，儒学文化传承的典范。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品经济萌芽、江南庭院建筑及古典戏场文化遗产的集大成者，古为今用的典范。",
      ...
      },
      {
        ...
        detailtop: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中国2000多座楼阁式宝塔中“上为令盛，下为重楼”的典型；巨型漆雕再现清代“乾隆盛世”苏州的繁华。",
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      detailtop: pageConfig.detailtop,
    ...
    this.innerAudioContext.src = pageConfig.bgm;
