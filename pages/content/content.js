  ...
  data: {
    ...
    pageConfig: [
      //
      {
        name: "天香小筑",
        imgs: [{
            url: '../img/detail/天香小筑1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/天香小筑2.jpg',
            isHave3D: true
          },
          {
            url: '../img/detail/天香小筑3.jpg',
            isHave3D: true
          }
        ],
      ...
      },
      {
        name: "太平天国忠王府",
        imgs: [{
            url: '../img/detail/太平天国忠王府1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/太平天国忠王府2.jpg',
            isHave3D: true
          }
        ],
        ...
        panorama: "../img/detail/太平天国忠王府1.jpg",
      ...
      },
      {
        ...
        panorama: "../img/detail/罗汉院双塔及正殿遗址1.jpg",
      ...
      },
      {
        name: "东吴大学（旧址）",
        imgs: [{
            url: '../img/detail/东吴大学1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/东吴大学2.jpg',
            isHave3D: true
          }
        ],
      ...
      },
      {
        name: "俞樾旧居（曲园）",
        imgs: [{
            url: '../img/detail/俞樾旧居1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/俞樾旧居2.jpg',
            isHave3D: true
          },
          {
            url: '../img/detail/俞樾旧居3.jpg',
            isHave3D: true
          }
        ],
      ...
      },
      {
        name: "开元寺无梁殿",
        imgs: [{
            url: '../img/detail/开元寺无梁殿1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/开元寺无梁殿2.jpg',
            isHave3D: true
          }
        ],
        ...
        panorama: "../img/detail/开元寺无梁殿1.jpg",
      ...
      },
      {
        name: "文庙大成殿",
        imgs: [{
            url: '../img/detail/文庙大成殿1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/文庙大成殿2.jpg',
            isHave3D: true
          }
        ],
        ...
        panorama: "../img/detail/文庙大成殿1.jpg",
      ...
      },
      {
        name: "全晋会馆",
        imgs: [{
            url: '../img/detail/全晋会馆1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/全晋会馆2.jpg',
            isHave3D: true
          }
        ],
      ...
      },
      {
        name: "甲辰巷砖塔",
        imgs: [{
            url: '../img/detail/甲辰巷砖塔1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/甲辰巷砖塔2.jpg',
            isHave3D: true
          }
        ],
        ...
        panorama: "../img/detail/甲辰巷砖塔1.jpg",
      ...
      },
      {
        name: "报恩寺塔（北寺塔）",
        imgs: [{
            url: '../img/detail/报恩寺塔1.jpg',
            isHave3D: false
          },
          {
            url: '../img/detail/报恩寺塔2.jpg',
            isHave3D: true
          }
        ],
